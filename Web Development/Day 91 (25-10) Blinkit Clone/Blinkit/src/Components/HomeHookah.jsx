...
export default function HomeHookah() {
  let HomeHookahvar = {
    dots: false,
    infinite: true,
    speed: 500,
  ...
  return (
    <div className='px-[40px] py-12' id='HomeHookah'>
      <div className='flex justify-between'>
        <h1 className='text-[25px] font-bold'>Hookah</h1>
        <button className='text-[20px] font-semibold text-green-700'>see all</button>
      </div>
      <Slider {...HomeHookahvar}>
        <div>
          <Homehookah />
        </div>
        <div>
...
function Homehookah() {
  return (
    ...
    <div className='mx-3 shadow-lg p-2'>
      <img src="https://cdn.grofers.com/cdn-cgi/image/f=auto,fit=scale-down,q=70,metadata=none,w=270/app/images/products/sliding_image/540986a.jpg" alt="" />
