                    ...
                    <div className='p-3'>
                        <form action="">
                            ...
                            <div className='py-5 flex flex-col gap-2'>
                                ...
                                <input type="file" name="storyimage" className=" w-full border border-gray-200 shadow-sm rounded-lg text-sm  file:bg-gray-50 file:border-0 file:me-4  file:py-3 file:px-4 " multiple="" />
                            </div>
                            <div className='py-5 flex flex-col gap-2'>
                                <label htmlFor="" className='font-semibold'>Banner Image</label>
                                <input type="file" name="storybannerimage" className=" w-full border border-gray-200 shadow-sm rounded-lg text-sm  file:bg-gray-50 file:border-0 file:me-4  file:py-3 file:px-4 " multiple="" />
                            </div>
