                    ...
                    <table className='w-[100%]'>
                        ...
                        <tbody>
                            <tr className='border-b-gray-300  border-[1px]'>
                                ...
                                <td className='py-2 text-start ps-5 text-gray-500'>Main Image</td>
                                <td className='py-2 text-start ps-5 text-gray-500'>New Summer must haves just dropped.</td>
                                <td className='py-2 text-start ps-5 text-gray-500'>Free Shipping on orders over $79</td>
                                <td className='py-2 text-start ps-5 text-gray-500'>
                                    <img src="https://i.ytimg.com/vi/CW_VEUQ0Lg0/maxresdefault.jpg" className='w-[70px] h-[70px] rounded-lg' alt="" />
                                </td>
                                ...
                                <td className='py-2 text-start ps-5 text-gray-500'>Display</td>
                            </tr>
