                    ...
                    <table className='w-[100%]'>
                        ...
                        <tbody>
                            <tr className='border-b-gray-300  border-[1px]'>
                                ...
                                <td className='py-2 text-start ps-5 text-gray-500'>Who we are...</td>
                                ...
                                <td className='py-2 text-start ps-5 text-gray-500'>
                                    <img src="https://cdn.dribbble.com/users/9358822/screenshots/17654770/media/55b47027c4011bc8cef2cc1657dcc3ab.jpg?resize=400x0" className='w-[100px] h-[70px] rounded-lg' alt="" />
                                </td>
                                <td className='py-2 text-start ps-5 text-gray-500'>
