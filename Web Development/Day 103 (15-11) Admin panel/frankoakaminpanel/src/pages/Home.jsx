...
export default function Home() {
    ...
    let [dropSize, setDropSize] = useState(false)
    let [pcat, setPCat] = useState(false)
    ...
    let [termsConditions, setTermsConditions] = useState(false)

    let dropDownshowHide = () => {
        setDropShow(!dropShow)
    }

    let dropDownshowHideSize = () => {
        setDropSize(!dropSize)
    }

    let dropDownshowHidePCat = () => {
        setPCat(!pcat)
    }

    let dropDownshowHideSubCat = () => {
        setSubCat(!SubCat)
    }

    let dropDownshowHideProduct = () => {
        setProduct(!product)
    }

    let dropDownshowHideStory = () => {
        setStory(!story)
    }

    let dropDownshowHideOrders = () => {
        setOrders(!orders)
    }

    let dropDownshowHideSlider = () => {
        setSlider(!Slider)
    }

    let dropDownshowHideTerms = () => {
    ...
    return (
        ...
        <div className='flex'>
            <aside className=' px-2 text-white w-[17%]   bg-[rgb(31,41,55)] scroll-m-0 ' >
                ...
                <div className='w-[100%]'>
                    <div className='flex cursor-pointer gap-3 group  w-[100%] hover:bg-gray-600 p-2 rounded-md ' onClick={dropDownshowHide}>
                        ...
                        <div className='w-[100%]' >
                            <span className='w-[100%] flex justify-between items-center mb-1 text-[17px] font-semibold'>Colors
                                ...
                                {dropShow ? <FaChevronUp className='text-[12px]' /> : <FaChevronDown className='text-[12px]' />}

                            </span>

                        </div>
                    </div>
                    <div className={` group-hover:bg-gray-800 w-[100%] px-4 ${dropShow ? '' : 'hidden'} `}>
                ...
                <div className='w-[100%]'>
                    <div className='flex cursor-pointer gap-3 group  w-[100%] hover:bg-gray-600 p-2 rounded-md ' onClick={dropDownshowHideSize}>
                        ...
                        <div className='w-[100%]' >
                            <span className='w-[100%] flex justify-between items-center mb-1 text-[17px] font-semibold'>Size
                                ...
                                {dropSize ? <FaChevronUp className='text-[12px]' /> : <FaChevronDown className='text-[12px]' />}

                            </span>

                        </div>
                    </div>
                    <div className={` group-hover:bg-gray-800 w-[100%] px-4 ${dropSize ? '' : 'hidden'} `}>
                ...
                <div className='w-[100%]'>
                    <div className='flex cursor-pointer gap-3 group  w-[100%] hover:bg-gray-600 p-2 rounded-md ' onClick={dropDownshowHidePCat}>
                        ...
                        <div className='w-[100%]' >
                            <span className='w-[100%] flex justify-between items-center mb-1 text-[17px] font-semibold'>Parent Category
                                ...
                                {pcat ? <FaChevronUp className='text-[12px]' /> : <FaChevronDown className='text-[12px]' />}

                            </span>

                        </div>
                    </div>
                    <div className={` group-hover:bg-gray-800 w-[100%] px-4 ${pcat ? '' : 'hidden'} `}>
                ...
                <div className='w-[100%]'>
                    <div className='flex cursor-pointer gap-3 group  w-[100%] hover:bg-gray-600 p-2 rounded-md ' onClick={dropDownshowHideSubCat}>
                        ...
                        <div className='w-[100%]' >
                            <span className='w-[100%] flex justify-between items-center mb-1 text-[17px] font-semibold'>Sub Category
                                ...
                                {SubCat ? <FaChevronUp className='text-[12px]' /> : <FaChevronDown className='text-[12px]' />}

                            </span>

                        </div>
                    </div>
                    <div className={` group-hover:bg-gray-800 w-[100%] px-4 ${SubCat ? '' : 'hidden'} `}>
                ...
                <div className='w-[100%]'>
                    <div className='flex cursor-pointer gap-3 group  w-[100%] hover:bg-gray-600 p-2 rounded-md ' onClick={dropDownshowHideProduct}>
                        ...
                        <div className='w-[100%]' >
                            <span className='w-[100%] flex justify-between items-center mb-1 text-[17px] font-semibold'>Product
                                ...
                                {product ? <FaChevronUp className='text-[12px]' /> : <FaChevronDown className='text-[12px]' />}

                            </span>

                        </div>
                    </div>
                    <div className={` group-hover:bg-gray-800 w-[100%] px-4 ${product ? '' : 'hidden'} `}>
                ...
                <div className='w-[100%]'>
                    <div className='flex cursor-pointer gap-3 group  w-[100%] hover:bg-gray-600 p-2 rounded-md ' onClick={dropDownshowHideStory}>
                        ...
                        <div className='w-[100%]' >
                            <span className='w-[100%] flex justify-between items-center mb-1 text-[17px] font-semibold'>Story
                                ...
                                {story ? <FaChevronUp className='text-[12px]' /> : <FaChevronDown className='text-[12px]' />}

                            </span>

                        </div>
                    </div>
                    <div className={` group-hover:bg-gray-800 w-[100%] px-4 ${story ? '' : 'hidden'} `}>
                ...
                <div className='w-[100%]'>
                    <div className='flex cursor-pointer gap-3 group  w-[100%] hover:bg-gray-600 p-2 rounded-md ' onClick={dropDownshowHideOrders}>
                        ...
                        <div className='w-[100%]' >
                            <span className='w-[100%] flex justify-between items-center mb-1 text-[17px] font-semibold'>Orders
                                ...
                                {orders ? <FaChevronUp className='text-[12px]' /> : <FaChevronDown className='text-[12px]' />}

                            </span>

                        </div>
                    </div>
                    <div className={` group-hover:bg-gray-800 w-[100%] px-4 ${orders ? '' : 'hidden'} `}>
                        <p className='group flex items-center gap-2 mb-2  hover:bg-gray-600 p-1 rounded-md '> <IoMdRadioButtonOn className='text-gray-500 group-hover:text-white cursor-pointer ' /> Orders</p>
                ...
                <div className='w-[100%]'>
                    <div className='flex cursor-pointer gap-3 group  w-[100%] hover:bg-gray-600 p-2 rounded-md ' onClick={dropDownshowHideSlider}>
                        <svg fill="currentColor" className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M75 75L41 41C25.9 25.9 0 36.6 0 57.9L0 168c0 13.3 10.7 24 24 24l110.1 0c21.4 0 32.1-25.9 17-41l-30.8-30.8C155 85.5 203 64 256 64c106 0 192 86 192 192s-86 192-192 192c-40.8 0-78.6-12.7-109.7-34.4c-14.5-10.1-34.4-6.6-44.6 7.9s-6.6 34.4 7.9 44.6C151.2 495 201.7 512 256 512c141.4 0 256-114.6 256-256S397.4 0 256 0C185.3 0 121.3 28.7 75 75zm181 53c-13.3 0-24 10.7-24 24l0 104c0 6.4 2.5 12.5 7 17l72 72c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-65-65 0-94.1c0-13.3-10.7-24-24-24z"></path></svg>
                        <div className='w-[100%]' >
                            <span className='w-[100%] flex justify-between items-center mb-1 text-[17px] font-semibold'>Slider

                                {Slider ? <FaChevronUp className='text-[12px]' /> : <FaChevronDown className='text-[12px]' />}

                            </span>

                        </div>
                    </div>
                    <div className={` group-hover:bg-gray-800 w-[100%] px-4 ${Slider ? '' : 'hidden'} `}>
                ...
                <div className='w-[100%]'>
                    <div className='flex cursor-pointer gap-3 group  w-[100%] hover:bg-gray-600 p-2 rounded-md ' onClick={dropDownshowHideTerms}>
                        ...
                        <div className='w-[100%]' >
                            <span className='w-[100%] flex justify-between items-center mb-1 text-[17px] font-semibold'>Terms & Conditions
                                ...
                                {termsConditions ? <FaChevronUp className='text-[12px]' /> : <FaChevronDown className='text-[12px]' />}

                            </span>

                        </div>
                    </div>
                    <div className={` group-hover:bg-gray-800 w-[100%] px-4 ${termsConditions ? '' : 'hidden'} `}>
                ...
                <footer className='w-[100%]'>
                    ...
                    <div className='flex justify-between items-center px-5'>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <p className='text-blue-700'>Kuldeep</p>
                        </div>
                    </div>
                </footer>
