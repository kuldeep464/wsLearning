        ...
        <div>
            <div className="w-full setbg">
                <div className=" w-full md:max-w-[1400px] flex text-wrap  justify-center flex-col items-center mx-auto py-6 text-white ">
                    <div className="flex flex-col pt-8 mb-2 items-center gap-10">
                        ...
                        <a href="/create"><button className="bg-[#ff8000] rounded-sm uppercase font-bold text-xs md:text-sm p-2">Create Your Blog</button></a>
                    </div>
                    <div className="md:text-xs text-[10px]	 leading-10  my-4 text-center	"><i><span className="index-module_type__E-SaG">Discover storytelling through our captivating </span></i></div>
                </div>
            </div>
            <div className="setbg shadow-lg border-t border-[black]">
                <div className="w-full flex justify-between px-10 mx-auto md:max-w-[1400px] text-xl py-2  text-center h-[70px] items-center text-white">
                    ...
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" className="text-3xl cursor-pointer animate-bounce" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
