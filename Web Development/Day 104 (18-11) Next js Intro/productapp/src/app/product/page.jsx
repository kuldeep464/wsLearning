...
export default function Product() {
  ...
  let product = () => {
    axios.get(`https://dummyjson.com/products?limit=16`)
      .then((res) => res.data)
      .then((finalres) => {
      ...
      <div className='grid grid-cols-4 gap-5 max-w-[1320px] mx-auto'>
        {productData.length >= 1 ?
          productData.map((items, index) => {
            return (
              <ProductItems key={index} data={items} />
            )
          })

          :

          <div className='grid w-[1320px] mx-auto grid-cols-4 gap-5'>
...
function ProductItems({ data }) {
  let { thumbnail, price, title, id } = data
  return (
