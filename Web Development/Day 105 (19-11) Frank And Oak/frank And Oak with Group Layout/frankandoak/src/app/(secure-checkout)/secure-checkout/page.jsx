                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <form action="" className='mb-14'>
                                        ...
                                        <input type="email" placeholder='Email' className='w-[100%] rounded my-2' />
                                        ...
                                        <input type="text" placeholder='Address' className='rounded w-[100%] mb-3' />

                                        <input type="text" placeholder='Apartment, suite, etc. (optional)' className='rounded w-[100%] mb-3' />
                                        ...
                                        : 
                                        <button className='bg-black py-2 w-[100%] text-white text-xl rounded'>Pay now</button>
                                        }
                    ...
                    <div className='bg-gray-100 h-[100vh] sticky overflow-y-scroll top-0 p-5'>
                        <div className='w-[60%]'>
                            ...
                            <div className='flex my-4 justify-between items-center'>
                                ...
                                <div className='text-[14px]'>$68.94</div>
                            </div>
                            <div className='flex my-4 justify-between items-center'>
                                <div className='text-[14px] flex items-center gap-1'>
                                    <span>Shipping</span>
                            ...
                            <div className='flex my-4 justify-between items-center'>
                                ...
                                <div className='flex items-center gap-2'>
                                    ...
                                    <span className='font-semibold text-[18px]'>$68.64</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-3'>
                    <div className='relative w-[67px] bg-gray-300 flex justify-center'>
                        <img src="https://cdn.shopify.com/s/files/1/0555/5722/6653/files/2130242-719.01_64x64.jpg?v=1729610640" className='' alt="" />
                    ...
                    <div>
                        <h2 className='text-[13px]'>The Seawool® Crewneck Sweater in Fade Rose</h2>
                        <h3 className='text-[13px] text-gray-400'>M</h3>
                    </div>
                </div>
                <div className='text-[15px]'>$66.99</div>
            </div>
        </div>
    )
}
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-3'>
                    ...
                    <div>
                        ...
                        <h3 className='text-[13px] text-gray-400'>$1.95</h3>
                    </div>
                </div>
                <div className='text-[15px]'>$1.95</div>
            </div>
        </div>
    )
}
